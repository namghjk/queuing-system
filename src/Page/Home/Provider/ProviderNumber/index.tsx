        ...
        <Card bordered>
          <Row gutter={24}>
            <Col span={8} offset={8}>
              ...
              <Text className={styles.label1}>Dịch vụ khách hàng lựa chọn</Text>
              <Form.Item
                name="service"
                required={false}
                rules={[
      ...
      >
        ...
        >
          ...
          <Form.Item
            name="email"
            label={
              <Typography.Text className={styles2.label}>Email</Typography.Text>
            }
            rules={[
              {
                type: "email",
          ...
          <Row gutter={16} justify="center" className={styles.buttonContainer}>
            <Col>
              <Button
                size="large"
                type="primary"
